...
## ✨ Новая версия 2.2 - Улучшения голосования, UI и экспорта
...
**Экспорт (новые функции):**
- ✅ **JPG** — скриншоты вкладок Brain Storm и Обсуждение (brainstorm.jpg, discussion.jpg)
- ✅ **Action Points** — HTML таблица с планами действий (action-points.html)
- ✅ **Confluence WIKI** — экспорт в формате Wiki Markup (.txt файлы)
- ✅ **HTML** — полный экспорт в HTML формате
- ✅ **PDF** — экспорт для печати
- ✅ **JSON** — полный экспорт данных сессии
